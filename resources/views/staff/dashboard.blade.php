            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                        <!-- Ver Socios -->
                        <div class="block p-6 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg opacity-50 cursor-not-allowed">
                            <div class="flex items-center">
                                <div class="text-4xl text-blue-600 mr-4">👥</div>
                                <div>
                                    <h4 class="font-bold text-lg text-blue-900">Ver Socios</h4>
                                    <p class="text-sm text-blue-700">Próximamente</p>
                                </div>
                            </div>
                        </div>
