                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                value="{{ old('name') }}" placeholder="Ej: Yoga, Crossfit, Spinning..." required autofocus />
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" 
                                placeholder="Describe la clase...">{{ old('description') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="capacity" name="capacity" type="number" class="mt-1 block w-full"
                                    value="{{ old('capacity', 20) }}" min="1" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="schedule" name="schedule" type="text" class="mt-1 block w-full"
                                    value="{{ old('schedule') }}" placeholder="Ej: Lunes 10:00 - 11:00" required />
